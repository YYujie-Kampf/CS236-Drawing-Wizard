...
# model save dir
PYTORCH_MODELS = '/content/drive/Shareddrives/CS236_Drawing_Wizard/checkpoints/Style/'
...
# test dataset
test_dir_path = '/content/drive/Shareddrives/CS236_Drawing_Wizard/results/dataset_style_ganilla/test'
test_path = test_dir_path + '/'

# test_model name
MODEL_NAME = "/content/drive/Shareddrives/CS236_Drawing_Wizard/checkpoints/Style/art_model-159.pkl"
